...
This script consists of a trained model processing to estimate LAI on the full crop growth period dataset:
"""
...
model_path = r"put the model path"  # Update with the correct path
...
def update_excel_data(image_name, canopy_cover,canopy_cover1,canopy_cover2, predicted_LAI):
    ...
    output_file_path = r"path for saving the output\canopy_data.xlsx"
...
def plot_temporal_data():
    ...
    plot_path = r"path for saving the output\canopy_data.xlsx\temporal_plotFull.jpg"
...
# RUN
image_path = r"path for saving the output\canopy_data.xlsx\IMG20240128122251.jpg"  # Replace with actual image path
